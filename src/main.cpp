...
int main() {
    // Initialize warehouse system with capacities
    int minHeapCap, maxHeapCap, hashMapCap;
    
    cout << "========== WAREHOUSE MANAGEMENT SYSTEM SETUP ==========" << endl;
    cout << "Enter MinHeap capacity (for lowest selling products): ";
    cin >> minHeapCap;
    cout << "Enter MaxHeap capacity (for best selling products): ";
    cin >> maxHeapCap;
    cout << "Enter HashMap capacity: ";
    cin >> hashMapCap;
    
    WarehouseSystem warehouse(minHeapCap, maxHeapCap, hashMapCap);
